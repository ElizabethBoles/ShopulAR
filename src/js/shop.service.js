(function() {
    'use strict';
    angular.module('shop').factory('ShopService', ShopService);
    function ShopService(){
        ...
        vm.items = [
            { "id": 2957, "name": "widget", "price": 320, "quantity": 203, "color": "red", "discount": 31 },
        ...
        function getItem(){
            return JSON.parse(localStorage.getItem('inventory')) || vm.items;
        }
        return {addItem: addItem, getItem: getItem};
    }
